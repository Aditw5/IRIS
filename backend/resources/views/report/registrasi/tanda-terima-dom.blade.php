    ...
    <table width="100%" style="margin-top: -19px; ">
        ...
        <table width="100%" style="margin-top: 5px; ">
            ...
            <tr>
                ...
                <td>
                    <span style="font-size: 9pt;color:#000000">
                        {{ \Carbon\Carbon::parse($res['identitas']->tglregistrasi)->isoFormat('D MMMM Y') }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <span style="font-size: 9pt;;color:#000000">
                        @if ($res['identitas']->lokasi == 'Jakarta')
                            Laboratorium Kalibrasi PT PLN NUSANTARA POWER UMRO JAKARTA
                        @else
                            Laboratorium Kalibrasi PT PLN NUSANTARA POWER UMRO Gresik
                        @endif
                    </span>
                </td>
            </tr>
                ...
                <tr>
                    ...
                    <td width="50%" class="text-center">
                        <span style="font-size: 10pt;" class="text-biasa">{{ $res['identitas']->lokasi }},
                            {{ \Carbon\Carbon::parse($res['identitas']->tglregistrasi)->isoFormat('D MMMM Y') }}</span>
                    </td>
                </tr>
                <tr>
                    <td width="50%" class="text-center">
        ...
        <tbody>
            @foreach ($res['alat'] as $index => $alat)
                <tr>
                    ...
                    <td width="25%" style="text-align: center; vertical-align: top; padding: 6px;">
                        @php
                            $fotoFiles = [];
                        ...
                        @elseif (!empty($shownFiles))
                            ...
                            @endif
                        @elseif (!empty($alat->alasanpenolakanregis))
                            <div style="color: red; font-size: 10pt; margin-top: 10px; word-break: break-word;">
                                {{ $alat->alasanpenolakanregis }}
                            </div>
                        @else
                            <span style="color: gray; font-size: 10pt;">Tidak ada file atau alasan penolakan</span>
                        @endif
                    </td>

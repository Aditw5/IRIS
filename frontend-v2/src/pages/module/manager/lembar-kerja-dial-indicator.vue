...
const jenisPenyimpanganAktif = computed<JenisPenyimpangan>(() => {
  ...
  return savedRow ? normalizeJenisPenyimpangan(savedRow.jenis_penyimpangan) : 'naik_turun'
})
...
const fetchData = async () => {
  ...
  await useApi().get(`manager/get-lembar-kerja-dial-indicator?norecdetail=${NOREC_DETAIL}`).then((response: any) => {

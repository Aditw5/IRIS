        ...
        <TabPanel>
          ...
          <VCard>
            <div class="column is-12">
              ...
              <DataTable :value="dataSourceHasilLembarKerja" :paginator="true" :rows="10"
                ...
                <template #header>
                  <div class="columns is-multiline is-vcentered is-mobile pt-0 pb-0" style="gap: 0.25rem;">
                    ...
                    <div class="column is-narrow" v-if="dataSourceHasilLembarKerja.length > 0">
                      <VButton color="danger" outlined icon="feather:trash" @click="batalRegis(dataSourceHasilLembarKerja)">
                        Tolak Sertifikat
                      </VButton>
                    </div>
                  </div>
...
const fetchData = async () => {
  ...
  await useApi().get(`manager/get-lembar-kerja-accellerometer?norecdetail=${NOREC_DETAIL}`).then((response: any) => {

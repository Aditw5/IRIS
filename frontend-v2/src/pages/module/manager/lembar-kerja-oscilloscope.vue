        ...
        <VCard>
          <div class="column is-12">
            ...
            <div class="columns is-multiline" style="text-align:center">
              <div class="column is-12">
                <h3 class="title is-5 mb-2 mr-1">Data Lembar Kerja Sub Lingkup Oscilloscope</h3>
              </div>
            </div>
            <DataTable :value="dataSourceHasilLembarKerja" dataKey="no"
              ...
              <Column field="skala_instrumen_satuan" />
              <Column field="indikasi_standar">
                <template #editor="{ data, field }">
                  <VField>
                    <VControl>
                      <VInput v-model="data[field]" />
              ...
              <Column field="indikasi_standar_satuan" />
              <Column field="indikasi_instrumen">
                <template #editor="{ data, field }">
                  <VField>
                    <VControl>
                      <VInput v-model="data[field]" />
              ...
              <Column field="indikasi_instrumen_satuan" />
...
const fetchData = async () => {
  ...
  await useApi().get(`manager/get-lembar-kerja-oscilloscope?norecdetail=${NOREC_DETAIL}`).then((response: any) => {

      ...
      <TabPanel>
        ...
        <VCard>
          <div class="column is-12">
            ...
            <DataTable :value="dataSourceHasilLembarKerjaView" editMode="row" dataKey="no" :paginator="true" :rows="10"
...
const fetchData = async () => {
  ...
  await useApi().get(`manager/get-lembar-kerja-tekanan?norecdetail=${NOREC_DETAIL}`).then((response: any) => {

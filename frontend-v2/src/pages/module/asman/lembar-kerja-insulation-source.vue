      ...
      <TabPanel>
        ...
        <VCard>
          <div class="column is-12">
            ...
            <h4>Insulation</h4>
            <DataTable :value="dataSourceHasilInsulation" dataKey="no"
              rowGroupMode="rowspan" groupRowsBy="group" :paginator="true" :rows="10"
            ...
            <h4>Source</h4>
            <DataTable :value="dataSourceHasilSource"
              dataKey="no"  rowGroupMode="rowspan" groupRowsBy="group"
...
const fetchData = async () => {
  ...
  try {
    const response = await useApi().get(`asman/get-lembar-kerja-insulation-source?norecdetail=${NOREC_DETAIL}`);
...
const cetakSertifikatLembarKerja = () => {
  H.printBlade(`asman/cetak-sertifikat-lembar-kerja?pdf=true&norec=${dataSourceHasilInsulation.value[0].norecregis}&norec_detail=${dataSourceHasilInsulation.value[0].detailregistraifk}`);
}

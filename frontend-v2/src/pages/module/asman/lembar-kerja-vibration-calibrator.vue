...
const fetchData = async () => {
  ...
  try {
    const response = await useApi().get(`asman/get-lembar-kerja-vibration-calibrator?norecdetail=${NOREC_DETAIL}`);
...
const cetakSertifikatLembarKerja = () => {
  ...
  H.printBlade(`asman/cetak-sertifikat-lembar-kerja?pdf=true&norec=${src[0].norecregis}&norec_detail=${src[0].detailregistraifk}`)
}

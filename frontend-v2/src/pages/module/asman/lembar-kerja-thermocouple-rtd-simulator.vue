      ...
      <TabPanel>
        ...
        <VCard>
          <div class="column is-12">
            ...
            <h4>Set Point</h4>
            <DataTable :value="dataSourceHasilSetpoint" dataKey="norec"
            ...
            <h4>Rentang</h4>
            <DataTable :value="dataSourceHasilRentang"
...
const fetchData = async () => {
  ...
  try {
    const response = await useApi().get(`asman/get-lembar-kerja-thermocouple-rtd-simulator?norecdetail=${NOREC_DETAIL}`);
...
const cetakSertifikatLembarKerja = () => {
  H.printBlade(`asman/cetak-sertifikat-lembar-kerja?pdf=true&norec=${firstResult().norecregis}&norec_detail=${firstResult().detailregistraifk}`);
}

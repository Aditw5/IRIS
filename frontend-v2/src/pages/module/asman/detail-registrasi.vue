          ...
          <div class="column is-12">
            <div class="block-header">
              ...
              <div class="center">
                <div class="columns">
                  <div class="column">
                    <h4 class="block-heading" v-if="mitra.tglregistrasi">Tanggal Registrasi</h4>
                    <p class="block-text" v-if="mitra.tglregistrasi">{{ mitra.tglregistrasi }}</p>
                    <h4 class="block-heading" v-if="mitra.nopendaftaran">No Pendaftaran</h4>
                    <p class="block-text" v-if="mitra.nopendaftaran">{{ mitra.nopendaftaran }}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="center column is-6 p-0">
                <div>
                  <div>
                    ...
                    <p class="block-hext" v-if="item.namamerk || item.namatipe">{{ item.namamerk }}/{{ item.namatipe }}</p>

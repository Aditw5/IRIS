...
const fetchData = async () => {
  ...
  await useApi().get(`pelaksana/get-lembar-kerja-vibration?norecdetail=${NOREC_DETAIL}`).then((response: any) => {
...
const Save = async () => {
  ...
  isLoadingSave.value = true;
  await useApi().post(
    `/pelaksana/save-data-upload-lembar-kerja-vibration`, json).then((response: any) => {
      isLoadingSave.value = false

    ...
    <TabView class="tabview-custom " :scrollable="true" @tab-click="klikTab($event)">
      <TabPanel>
        <template #header>
          ...
          <span>Lembar Kerja AI Vibrasi</span>
        ...
        <VCard>
          <div class="column is-12">
            ...
            <div class="columns is-multiline" style="text-align:center">
              <div class="column is-12">
                <h3 class="title is-5 mb-2 mr-1">Data Lembar Kerja AI Vibrasi</h3>
              </div>
            </div>
            <DataTable :value="dataSourceHasilLembarKerja" editMode="row" dataKey="no"
              ...
              <ColumnGroup type="header">
                <Row>
                  <Column header="Frekuensi" />
                  <Column header="Vibrasi Reference" />
                  <Column header="UUT" />
...
useHead({
  title: 'Lembar Kerja AI Vibrasi - ' + import.meta.env.VITE_PROJECT,
})

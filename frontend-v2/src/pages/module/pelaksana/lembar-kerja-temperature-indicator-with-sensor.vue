        ...
        <VCard>
          ...
          <div class="column is-12" v-else>
            ...
            <div class="columns is-multiline">
              ...
              <div class="column is-3 mt-5-min">
                <div class="column is-12">
                  <span>Jenis Sensor</span>
                </div>
                <VField>
                  <VControl>
                    <VInput v-model="item.jenissensor" placeholder="Jenis Sensor" />
                  </VControl>
                </VField>
              </div>
            </div>
              ...
              <div class="column is-3 mt-4">
                <VCardCustom :style="'padding:5px 25px'">
                  <div class="label-status success">
                    ...
                    <span class="ml-1">TOTAL DATA TEMPERATURE INDICATOR WITH SENSOR</span>
                  </div>
        ...
        <VCard>
          <div class="column is-12">
            ...
            <div class="columns is-multiline" style="text-align:center">
              <div class="column is-12">
                <h3 class="title is-5 mb-2 mr-1">Data Upload Lembar Kerja Sub Lingkup Temperature Indicator With Sensor </h3>
              </div>
            </div>
...
const downloadTemplate = () => {
  window.open('/service/pelaksana/download-template-lembar-kerja-temperature-indicator?token=' + useUserSession().token, '_blank');
}
...
const fetchData = async () => {
  ...
  await useApi().get(`pelaksana/get-lembar-kerja-temperature-indicator?norecdetail=${NOREC_DETAIL}`).then((response: any) => {
...
const Save = async () => {
  ...
  if (!item.value.jenissensor) { H.alert('warning', 'Jenis Sensor harus di isi'); return }
  ...
  let json = {
    ...
    'jenissensor': item.value.jenissensor
  }
  isLoadingSave.value = true;
  await useApi().post(
    `/pelaksana/save-data-upload-lembar-kerja-temperature-indicator`, json).then((response: any) => {
      isLoadingSave.value = false

...
const fetchData = async () => {
  ...
  await useApi().get(`pelaksana/get-lembar-kerja-insulation-meter-resistansi?norecdetail=${NOREC_DETAIL}`).then((response: any) => {
...
const Save = async () => {
  ...
  try {
    isLoadingSave.value = true
    await useApi().post('/pelaksana/save-data-upload-lembar-kerja-insulation-meter-resistansi', formData)
    isLoadingSave.value = false

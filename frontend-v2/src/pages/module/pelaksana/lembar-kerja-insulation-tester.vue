...
const fetchData = async () => {
  ...
  await useApi().get(`pelaksana/get-lembar-kerja-insulation-tester?norecdetail=${NOREC_DETAIL}`).then((response: any) => {
...
const Save = async () => {
  ...
  try {
    isLoadingSave.value = true
    await useApi().post('/pelaksana/save-data-upload-lembar-kerja-insulation-tester', formData)
    isLoadingSave.value = false

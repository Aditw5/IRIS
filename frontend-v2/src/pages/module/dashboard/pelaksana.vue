<template>
              ...
              <TabPanel>
                ...
                <div v-if="activeTab == 0">
                  <div class="column is-6 date-filter-container">
                    <!-- HANYA TAMBAH handler update:modelValue -->
                    <VDatePicker v-model="filterTgl" is-range color="pink" trim-weeks
                      ...
                      <template #default="{ inputValue, inputEvents }">
                        <VField addons>
                          ...
                          <VControl>
                            <VButton static><i class="fas fa-arrow-right"></i></VButton>
                          </VControl>
                          <VControl icon="feather:calendar">
                  ...
                  <div class="list-view list-view-v3">
                    ...
                    <VCard class="text-center pt-0 pb-0 mt-0">
                      ...
                      <VRadio v-model="order" value="2" label="Sudah Dikerjakan" name="outlined_radio" color="info" />
                    </VCard>
                            ...
                            <div class="list-view-item-inner">
                              ...
                              <div class="meta-left">
                                <h3>
                                  <b>{{ item.namaproduk }}</b>
                                  <VTag
                                    v-if="item.isdraftlaporanrepair === true || item.isdraftlaporanrepair === 1 || item.isdraftlaporanrepair === '1'"
                                    class="ml-1" :label="'Sudah isi draft'" :color="'warning'" />
                                ...
                                <h4 v-if="item.jenisorder == 'repair'">
                                  <b>({{ item.namaperusahaan }})</b>
                                </h4>
                                ...
                                <div v-if="item.jenisorder === 'kalibrasi'">
                                  <WorksheetAttachments :norec="item.norec_detail" role="pelaksana" compact />
                                </div>
                                ...
                                <div v-if="item.istolaksertiasman === true" class="tolak-serti-anim"
                                  ...
                                  <div v-if="item.isverifikasi == true" class="tolak-serti-text">
                                    <div class="tolak-serti-title tolak-serti-red">Laporan Verifikasi Ditolak Asman
                                    </div>
                                    <div class="tolak-serti-ket">
                              ...
                              <div class="meta-right flex justify-center items-center">
                                <div class="buttons">
                                  <VIconButton v-if="item.statusorderpelaksana == 1"
                                    v-tooltip.bottom.left="'Input Progres Harian'" icon="feather:plus"
                                    @click="progresHarian(item)" color="info" raised circle class="mr-2">
                                  </VIconButton>
                                  <VIconButton v-tooltip.bottom.left="'SPK'" icon="feather:printer"
                                    @click="cetakSpk(item)" color="warning" raised circle class="mr-2">
                                  </VIconButton>
                                  <VIconButton
                                    v-if="item.pelaksanaisilembarkerjafk != null && item.isverifikasi == null"
                                  ...
                                  <VIconButton
                                    v-if="item.pelaksanaisilembarkerjafk != null && item.isverifikasi == true"
                                  ...
                                  <VIconButton
                                    v-if="item.sublingkupfk != null && item.lingkupfk != 2 && item.statusorderpelaksana == 2 && (item.setujuilembarkerjaasman == null || item.setujuilembarkerjaasman == false) && item.jenisorder == 'kalibrasi'"
                                  ...
                                  <VIconButton
                                    v-if="item.sublingkupfk == null && item.lingkupfk != 2 && item.statusorderpelaksana == 1 && (item.setujuilembarkerjaasman == null || item.setujuilembarkerjaasman == false) && item.jenisorder == 'kalibrasi'"
                                    color="info" circle icon="fas fa-pager" outlined raised
                                    @click="masukLembarKerja(item)" v-tooltip.bottom.left="'Lembar Kerja'" />
                                  <VIconButton
                                    v-if="item.lingkupfk == 2 && (item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) && (item.setujuilembarkerjaasman == null || item.setujuilembarkerjaasman == false) && item.jenisorder == 'kalibrasi'"
                                    color="info" circle icon="fas fa-pager" outlined raised
                                    @click="masukLembarKerjaTekanan(item)" v-tooltip.bottom.left="'Lembar Kerja'" />
                                  <VIconButton v-if="
                                    (item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) &&
                                  ...
                                  <VIconButton
                                    v-if="(item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) && item.jenisorder == 'repair' && (item.pelaksanaisilaporanrepairfk != null || item.isdraftlaporanrepair === true || item.isdraftlaporanrepair === 1 || item.isdraftlaporanrepair === '1')"
                                  ...
                                  <VIconButton
                                    v-if="(item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) && item.jenisorder == 'repair' && item.asmansetujulaporanrepairfk == null"
                                  ...
                                  <VIconButton v-tooltip.bottom.left="'Aktivitas'" icon="feather:activity"
                                    v-if="item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2"
                                    @click="detailOrder(item)" color="info" raised circle class="mr-2">
                                  </VIconButton>
                                  <VIconButton
                                    v-if="(item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) && item.jenisorder == 'kalibrasi'"
                                    v-tooltip.bottom.left="'Kamera ASCI'" icon="feather:camera"
                                    @click="openCameraASCI(item)" color="success" raised circle class="mr-2">
                                  </VIconButton>
                                  <VIconButton v-tooltip.bottom.left="'Ajukan Amandemen'" icon="feather:edit"
                                    v-if="item.setujuilembarkerjamanager == true && item.jenisorder == 'kalibrasi'"
                                    @click="pengajuanAmandemen(item)" color="info" raised circle class="mr-2">
                                  </VIconButton>
                                  <VIconButton v-tooltip.bottom.left="'Ajukan Amandemen'" icon="feather:edit"
                                  ...
                                  <VIconButton
                                    v-if="item.tanda_kalibrasi_ai == 'ADA' && item.sublingkupfk == null && (item.statusorderpelaksana == 1 || item.statusorderpelaksana == 2) && (item.setujuilembarkerjaasman == null || item.setujuilembarkerjaasman == false) && item.jenisorder == 'kalibrasi'"
  ...
  <VModal :open="modalDetailOrder" title="Verifikasi" noclose size="big" actions="right"
    ...
    <template #content>
      <div class="column is-12">
        ...
        <div class="mb-4" v-if="item.tanggalmulai == null">
          <div class="p-4" style="
          ...
          ">
            ...
            <div style="font-size: 15px; margin-top: 6px; line-height: 1.5;">
              Setelah Anda klik <b>Simpan Verif</b>, sistem akan otomatis mengisi <b>Tanggal Mulai</b>.
  ...
  <VModal :open="modalInputProgres" title="Input Progres harian" noclose size="big" actions="right"
    @close="modalInputProgres = false" cancelLabel="Tutup">
    <template #content>
      <div class="column is-12">
        <table width="100%">
          <thead>
            <tr class="tr-po">
              ...
              <th class="th-po" width="68%" style="vertical-align:inherit;text-align: center;">
                Progres Harian
              </th>
              <th class="th-po" width="12%" style="vertical-align:inherit;text-align: center;">
                Aksi
              </th>
            </tr>
          </thead>
          <tbody v-for="(items, index) in item.detailProgresHarian" :key="index">
            <tr class="tr-po">
              <td class="td-po">
                <div class="column pt-3 pb-0">
                  <VField>
                    <VLabel class="required-field">Tanggal Isi</VLabel>
                    <VDatePicker v-model="items.tanggalisi" mode="dateTime" style="width: 100%" trim-weeks
                      :max-date="new Date()">
                      <template #default="{ inputValue, inputEvents }">
                        <VField>
              ...
              <td class="td-po">
                <div class="column pt-3 pb-0">
                  <VField>
                    <VControl>
                      <VTextarea v-model="items.progresharian" rows="3" placeholder="Progres Harian">
                      </VTextarea>
                    </VControl>
                  </VField>
                </div>
    ...
    <template #action>
      <VButton icon="feather:save" @click="saveProgresHarian()" color="info" :loading="isLoadingSave" raised>Simpan
      </VButton>
    </template>
  </VModal>
  ...
  <VModal :open="modalBukaLembarKerjaTekanan" title="Status KAN" noclose size="medium" actions="right"
    @close="modalBukaLembarKerjaTekanan = false, clear()" cancelLabel="Tutup">
    <template #content>
  ...
  <VModal :open="modalAmandemen" title="Pengajuan Amandemen" size="medium" actions="right" cancelLabel="Tutup"
    @close="modalAmandemen = false">
    <template #content>
      <div class="amandemen-wrap">
        ...
        <div class="amandemen-card">
          <div class="amandemen-title">Alasan Pengajuan Amandemen</div>

          <VField>
            <VControl>
              <VTextarea class="textarea is-rounded" v-model="amandemenForm.alasanpengajuan" rows="5"
                placeholder="Tulis alasan pengajuan amandemen..." autocomplete="off" autocapitalize="off"
                spellcheck="true" />
            </VControl>
          </VField>

          <div class="hint">*Wajib diisi sebelum simpan</div>
        </div>
      </div>
    </template>

    <template #action>
      <VButton icon="feather:plus" color="primary" raised :loading="isLoading"
        :disabled="!amandemenForm.alasanpengajuan.trim()" @click="savePengajuanAmandemen">
        Simpan
      </VButton>
    </template>
  </VModal>
...
let modalInputProgres: any = ref(false)
...
const modalAmandemen: any = ref(false)
...
const item: any = ref({
  aktif: true,
  fStatusVerif: 0,
  detailProgresHarian: [{ no: 1, tanggalisi: new Date() }],
  qsearch: ''
})
...
const pengajuanAmandemen = (e: any) => {
  amandemenForm.namaalat = e?.namaproduk ?? '-'
  amandemenForm.namatipe = e?.namatipe ?? '-'
  amandemenForm.namamerk = e?.namamerk ?? '-'
  amandemenForm.namaserialnumber = e?.namaserialnumber ?? '-'
  amandemenForm.noorderalat = e?.noorderalat ?? '-'
  amandemenForm.norec_detail = e?.norec_detail ?? '-'
  amandemenForm.alasanpengajuan = e?.alasanpengajuan ?? '',

    modalAmandemen.value = true
}

const savePengajuanAmandemen = async () => {
  if (!amandemenForm.alasanpengajuan) { H.alert('warning', 'Alasan Pengajuan harus di isi'); return }
  let json = {
    mitraregis: {
      'norec_detail': amandemenForm.norec_detail,
      'alasanpengajuan': amandemenForm.alasanpengajuan,
      'noorderalat': amandemenForm.noorderalat,
    }
  }
  isLoading.value = true
  await useApi()
    .post(`/pelaksana/save-pengajuan-amandemen`, json)
    .then((response: any) => {
      isLoading.value = false
      modalAmandemen.value = false
      // clear()
      fetchAlatKalibrasi(2)
      fetchDataRiwayat()
    })
    .catch((e: any) => {
      isLoading.value = false
...
const fetchDataRiwayat = async () => {
  isLoading.value = true
  try {
    const res = await useApi().get('pelaksana/get-pengajuan-amandemen')
    const rows = res?.data ?? []
...
const fetchAlatKalibrasi = async (q: any) => {
  ...
  marqueeText.value = response.titlePelaksana
...
const addNewProgresHarian = (index: number) => {
  item.value.detailProgresHarian.splice(index + 1, 0, {
    no: item.value.detailProgresHarian.length + 1,
    progresharian: '',
    tanggalisi: new Date()
  });
};

const removeProgresHarian = (index: number) => {
  item.value.detailProgresHarian.splice(index, 1);
  if (item.value.detailProgresHarian.length === 0) {
    item.value.detailProgresHarian.push({
      no: 1,
      progresharian: '',
      tanggalisi: new Date()
    });
...
const progresHarian = async (e: any) => {
  modalInputProgres.value = true
  item.value.norec_detail = e.norec_detail
  isLoadDataOrder.value = true

  const response = await useApi().get(`/pelaksana/get-progres-harian?norec_pd=${e.norec_detail}`)
  const data = response.detail.map((element: any, i: number) => ({
    no: i + 1,
    norec: element.norec,
    progresharian: element.progresharian ?? '',
    tanggalisi: element.tanggalisi ? new Date(element.tanggalisi) : new Date()
  }))

  item.value.detailProgresHarian = data.length > 0 ? data : [{
    no: 1,
    norec: '',
    progresharian: '',
    tanggalisi: new Date()
...
const saveProgresHarian = async () => {
  if (!item.value.detailProgresHarian || item.value.detailProgresHarian.length === 0) { H.alert('warning', 'Status Alat harus diisi'); return; }

  const dataProgres = item.value.detailProgresHarian.map((alat: any) => ({
    norec: alat.norec ?? '',
    progresharian: alat.progresharian ?? null,
    tanggalisi: alat.tanggalisi ? H.formatDate(alat.tanggalisi, 'YYYY-MM-DD HH:mm:ss') : null,
  }));
  ...
  try {
    await useApi().post('/pelaksana/simpan-progres-harian-repair', json);
    isLoadingSave.value = false;
    modalInputProgres.value = false;
...
const cetakLaporanVerfikasi = (e: any) => {
  H.printBlade(`pelaksana/cetak-laporan-verifikasi?pdf=true&norec=${e.norec}&norec_detail=${e.norec_detail}`)
}


const cetakLaporanRepair = (e: any) => {
  H.printBlade(`pelaksana/cetak-laporan-repair?pdf=true&norec=${e.norec}&norec_detail=${e.norec_detail}`);
}

const downloadFileTerunggah = (e: any) => {
  const token = useUserSession().token
  const url = `/service/pelaksana/download-file-terunggah?norec=${e.norec_detail}&token=${token}`
...
const masukLaporanVerifikasi = async (e: any) => {
  router.push({
    name: 'module-pelaksana-laporan-verifikasi',
    query: {
      norec: e.norec,
      norec_detail: e.norec_detail
    }
...
const openCameraASCI = (e: any) => {
  const noorder = String(e?.noorderalat ?? 'camera')
    .trim()
    .toLowerCase()
    .replace(/[^a-z0-9]+/g, '-')
    .replace(/^-|-$/g, '')
  ...
  const cameraRoute = router.resolve({
    name: 'camera',
    query: {
      room: `${noorder || 'camera'}-${randomPart}`,
      role: 'asci',
      noorder: e?.noorderalat ?? '',
      norec: e?.norec ?? '',
      norec_detail: e?.norec_detail ?? '',
      alat: e?.namaproduk ?? '',
      mode: 'calibration',
...
const isLingkupVibrasi = (e: any) => {
  return String(e.lingkupkalibrasi ?? '').trim().toUpperCase() === 'VIBRASI'
}

const isLingkupSuhu = (e: any) => {
  return String(e.lingkupkalibrasi ?? '').trim().toUpperCase() === 'SUHU & KELEMBABAN'
}

const getKalibrasiAiSublingkup = async (e: any) => {
  const namaSublingkup = isLingkupVibrasi(e)
    ? 'KALIBRASI AI VIBRASI'
    : isLingkupSuhu(e)
      ? 'KALIBRASI AI SUHU'
      : 'KALIBRASI AI'
  const response = await useApi().get(
    `pelaksana/get-sublingkup?lingkup=${e.lingkupfk}&param_search=namasublingkup&query=${encodeURIComponent(namaSublingkup)}`
  )
  return response.data.find((sub: any) => sub.namasublingkup === namaSublingkup)
}
...
const lembarKerjaAI = async (e: any) => {
  ...
  isLoading.value = true
  try {
    const sublingkup = await getKalibrasiAiSublingkup(e)
    if (!sublingkup) {
      H.alert('warning', 'Sub lingkup Kalibrasi AI belum tersedia untuk lingkup ini')
      return
    }

    await useApi().post('/pelaksana/save-status-kan', json)
    isLoading.value = false
    router.push({
      name: isLingkupVibrasi(e)
        ? 'module-pelaksana-lembar-kerja-yolo-vibrasi'
        : 'module-pelaksana-lembar-kerja-yolo',
      query: {
        norec: e.norec,
        norec_detail: e.norec_detail,
        sublingkup: sublingkup.id,
      }
    })
  } catch (error: any) {
    console.error('Error saat menyimpan berkas mitra:', error);
...
const lembarKerja = (e: any) => {
  ...
  useApi().post('/pelaksana/save-status-kan', json).then((r) => {
    ...
    if (e.daftarsublingkup.label == 'METER') {
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-sumber',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-clamp',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-vibration-meter',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-accellerometer',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-clamp-meter',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-meter-sumber',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-termometer-infrared',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-thermal-imager',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-thermohygrometer',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-dryblock',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-vibration-calibrator',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-caliper-micrometer',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-dial-indicator',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-bore-gauge',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-clamp-meter-sumber',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-continuity-+source',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-tachometer',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-insulation-meter-resistansi',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-torque-wrench',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-temperature-indicator-with-sensor',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-ultrasonic-thickness',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-thickness-gauge',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-feeler-gauge',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-insulation-tester',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-insulation-source',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-micrometer-head',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-outside-micrometer',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-thermocouple-rtd-simulator',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
      ...
      router.push({
        name: 'module-pelaksana-lembar-kerja-oscilloscope',
        query: {
          norec: e.norec,
          norec_detail: e.norec_detail,
          sublingkup: e.daftarsublingkup.value,
...
const masukLembarKerjaSudahIsi = (e: any) => {
  ...
  if (e.namasublingkup == 'METER') {
    ...
    router.push({
      name: 'module-pelaksana-lembar-kerja-yolo',
      query: {
        norec: e.norec,
        norec_detail: e.norec_detail,
        sublingkup: e.sublingkupfk,
  ...
  } else if (e.namasublingkup == 'KALIBRASI AI VIBRASI') {
    router.push({
      name: 'module-pelaksana-lembar-kerja-yolo-vibrasi',
      query: {
        norec: e.norec,
        norec_detail: e.norec_detail,
        sublingkup: e.sublingkupfk,
...
const lembarKerjaTekanan = (e: any) => {
  ...
  useApi().post('/pelaksana/save-status-kan', json).then((r) => {
    isLoading.value = false
    router.push({
      name: 'module-pelaksana-lembar-kerja-tekanan',
      query: {
        norec: e.norec,
        norec_detail: e.norec_detail
      }
...
watch(
  ...
  (newValue, oldValue) => {
    if (newValue != oldValue) {
      fetchAlatKalibrasi(item.value.statusorderpelaksana)
    }
  }
)
watch(
...
.marquee-container {
  overflow: hidden;
  background: #111;
  /* Kamu bisa ganti warna background bila perlu */
  padding: 1rem 0;
  /* Tinggi container jadi lebih besar */
}
...
.marquee-content {
  ...
  white-space: nowrap;
  font-size: 2rem;
  /* dari 1rem → 2rem untuk lebih besar */
  font-weight: bold;
  padding-left: 100%;
  /* Dua animasi: slide & RGB blink */
  animation:
    marquee 10s linear infinite,
    blinkRGB 3s linear infinite;
}

...
<template>
  <div class="sidebar-layout">
    ...
    <Transition name="slide-x">
      <LayoutsMobileSubsidebar v-if="isMobileSideblockOpen && activeMobileSubsidebar === 'layout'" />
      <DashboardsMobileSubsidebar v-else-if="isMobileSideblockOpen && activeMobileSubsidebar === 'dashboard'" />
      <ComponentsMobileSubsidebar v-else-if="isMobileSideblockOpen && activeMobileSubsidebar === 'components'" />
      <ElementsMobileSubsidebar v-else-if="isMobileSideblockOpen && activeMobileSubsidebar === 'elements'" />
    </Transition>
    ...
    <Transition name="slide-x">
      <Sideblock v-if="isDesktopSideblockOpen" :theme="props.theme">
        ...
        <template #links>
          ...
          <li>
            <RouterLink :to="{ name: 'sidebar-dashboards-personal-2' }" class="single-link">
              <span class="icon">
          ...
          <li>
            <RouterLink :to="{ name: 'sidebar-dashboards-human-ressources' }" class="single-link">
              <span class="icon">
          ...
          <li>
            <RouterLink :to="{ name: 'sidebar-dashboards-personal-3' }" class="single-link">
              <span class="icon">
          ...
          <li>
            <RouterLink :to="{ name: 'sidebar-layouts-profile-view' }" class="single-link">
              <span class="icon">
          ...
          <VCollapseLinks v-model:open="openSideblockLinks" collapse-id="starters">
            ...
            <RouterLink :to="{ name: 'starters-sideblock-blank-page-1' }" class="is-submenu">
              <i aria-hidden="true" class="lnil lnil-layout"></i>
              <span>Regular Sideblock</span>
              <VTag class="ml-2" label="v2.2" color="primary" size="tiny" outlined curved />
            </RouterLink>
            <RouterLink :to="{ name: 'starters-sideblock-blank-page-2' }" class="is-submenu">
              <i aria-hidden="true" class="lnil lnil-layout"></i>
              <span>Curved Sideblock</span>
              <VTag class="ml-2" label="v2.2" color="primary" size="tiny" outlined curved />
            </RouterLink>
            <RouterLink :to="{ name: 'starters-sideblock-blank-page-3' }" class="is-submenu">
              <i aria-hidden="true" class="lnil lnil-layout"></i>
              <span>Colored Sideblock</span>
              <VTag class="ml-2" label="v2.2" color="primary" size="tiny" outlined curved />
            </RouterLink>
            <RouterLink :to="{ name: 'starters-sideblock-blank-page-4' }" class="is-submenu">
              <i aria-hidden="true" class="lnil lnil-layout"></i>
              <span>Curved Colored</span>
              <VTag class="ml-2" label="v2.2" color="primary" size="tiny" outlined curved />
            </RouterLink>
        ...
        <template #bottom-links>
          ...
          <a class="search-link" aria-label="Display search panel" data-content="Search" tabindex="0"

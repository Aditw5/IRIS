  ...
  <div class="navbar-layout">
    ...
    <MobileSidebar :is-open="isMobileSidebarOpen" @toggle="isMobileSidebarOpen = !isMobileSidebarOpen">
      <template #links>
        ...
        <li>
          <a :class="[activeMobileSubsidebar === 'layout' && 'is-active']" tabindex="0"
            @keydown.space.prevent="activeMobileSubsidebar = 'layout'" @click="activeMobileSubsidebar = 'layout'">
        ...
        <div class="centered-search" :class="[!displaySearch && 'is-hidden']">
          <div class="field">
            <div class="control has-icon">
              ...
              <div id="navbar-navbar-search-close" class="form-icon is-right" tabindex="0"
                @keydown.space.prevent="displaySearch = false" @click="displaySearch = false">

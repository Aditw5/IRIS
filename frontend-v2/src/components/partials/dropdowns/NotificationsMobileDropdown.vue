        ...
        <ul class="notification-list">
          <!-- <li>
            <a class="notification-item">
              <div class="img-left">
                <img class="user-photo" alt="" src="/images/avatars/svg/vuero-4.svg"
          ...
          <li>
            <a class="notification-item">
              <div class="img-left">
                <img class="user-photo" alt="" src="/images/avatars/svg/vuero-2.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')" />
              </div>
              <div class="user-content">
                <p class="user-info">
          ...
          <li>
            <a class="notification-item">
              <div class="img-left">
                <img class="user-photo" alt="" src="/images/avatars/svg/vuero-5.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')" />
              </div>
              <div class="user-content">
                <p class="user-info">
          ...
          <li>
            <a class="notification-item">
              <div class="img-left">
                <img class="user-photo" alt="" src="/images/avatars/svg/vuero-9.svg"
                  @error.once="(event) => onceImageErrored(event, '150x150')" />
              </div>
              <div class="user-content">
                <p class="user-info">
